...
export const RELATIONAL_DATABASE_THEORY_BLOGS = [
  {
    ...
    url: "https://j2k8zv.substack.com/p/learn-mysql-top-and-common-commands",
  },
  {
    title: "Learn Postgres - Top and Common Commands to Get Started",
    category: BLOG_CATEGORIES.DATABASES,
    url: "https://j2k8zv.substack.com/p/learn-postgres-top-and-common-commands",
  },
  {
    title: "Learn SQLite - Top and Common Commands to Get Started",
    category: BLOG_CATEGORIES.DATABASES,
...
export const DATABASE_THEORY_BLOGS = [
  {
    ...
    category: BLOG_CATEGORIES.DATABASES,
    url: "https://j2k8zv.substack.com/p/a-beginners-introduction-to-professional",
  },
  {
    title: "Technical In-Depth Guide into Database Design",
    category: BLOG_CATEGORIES.DATABASES,
    url: "https://j2k8zv.substack.com/p/technical-in-depth-guide-into-database",
  },
];
